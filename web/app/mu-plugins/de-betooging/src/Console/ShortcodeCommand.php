...
class ShortcodeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'de-betooging:shortcode {name : The shortcode name}';
    ...
    public function handle()
    {
        ...
        $viewPath = view()->getFinder()->getHints()['DeBetooging'][0] . '/shortcodes/';
    ...
    protected function getPath($name)
    {
        ...
        return app('de_betooging.base_path') . '/Shortcodes/' . $fileName;
    }
}
