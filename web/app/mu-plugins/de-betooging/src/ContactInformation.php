...
class ContactInformation
{
    ...
    public function formattedAddress() {
        return view('DeBetooging::contact-information.address', [
    ...
    public function formattedPhoneEmail() {
        return view('DeBetooging::contact-information.phone-email', [
            'phone' => $this->phone(),
            'email' => $this->email(),
        ])->toHtml();
    }
    ...
    public function formattedPhone() {
        return view('DeBetooging::contact-information.phone', [
            'phone' => $this->phone(),
        ])->toHtml();
    }

    public function formattedEmail() {
        return view('DeBetooging::contact-information.email', [
            'email' => $this->email(),
        ])->toHtml();
    }
}
