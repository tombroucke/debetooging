...
export default async (app) => {
  ...
  */
  ...
  .proxy("https://debetooging.test")
  .serve({
    host: "debetooging.test",
    cert: app.path('@certs/debetooging.test.crt'),
    key: app.path('@certs/debetooging.test.key'),
  })

  /**
  * URI of the `public` directory
  */
  .setPublicPath("/app/themes/debetooging/public/");
};
